...
interface ScanHistoryDao {
    ...
    @Query("DELETE FROM graph_edges WHERE relation IN ('OBSERVED', 'AT_PLACE', 'REPEAT')")
    suspend fun deleteAutoGeneratedEdges()

    @Query("DELETE FROM graph_nodes WHERE nodeType IN ('SCAN', 'PLACE', 'SIGNAL')")
    suspend fun deleteAutoGeneratedNodes()
